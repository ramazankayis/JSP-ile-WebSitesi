		...
		<section class="grid col-three-quarters mq2-col-full">
			...
			<div class="grid-wrap works">
				...
				<section class="part clearfix">
					...
					<figure class="work">
						<a
							href="liste.jsp?kategoriid=<%=rsDilTeknoloji.getInt(1)%>&kategoriadi=<%=rsDilTeknoloji.getString(4)%>&kategoriresimadi=<%=rsDilTeknoloji.getString(5)%>">
							<img src="img/<%=rsDilTeknoloji.getString(5)%>"
							alt="<%=rsDilTeknoloji.getString(4)%>"> <span class="zoom"></span>
						</a>
						<figcaption>
							<a
								href="liste.jsp?kategoriid=<%=rsDilTeknoloji.getInt(1)%>&kategoriadi=<%=rsDilTeknoloji.getString(4)%>&kategoriresimadi=<%=rsDilTeknoloji.getString(5)%>"
								class="arrow"><%=rsDilTeknoloji.getString(4)%></a>
							<!--  <p></p> -->
						</figcaption>
					</figure>
