...
<body>
	...
	<div class="main center">
		...
		<header class="grid col-full">
			<hr>
			<figure
				class="grid col-one-third mq1-col-one-half mq2-col-one-third mq3-col-full work_1">
				<figcaption>
				...
				<a href="#"><img
					src="img/<%=request.getParameter("kategoriresimadi")%>"
					alt="<%=request.getParameter("kategoriadi")%>" /> <span
					class="zoom"></span> </a>
			</figure>
					...
					<ul>
						...
						<%
							...
							try {
								...
								rstVideoListesi = stmtVideoListesi
						...
						%>
						<figcaption>
							<li><%=rstVideoListesi.getString("videosirasi")%>. <a
								class="arrow"
								href="izle.jsp?anakategoriid=<%=rstVideoListesi.getInt("anakategoriid")%>&kategoriid=<%=rstVideoListesi.getInt("kategoriid")%>&videosirasi=<%=rstVideoListesi.getInt("videosirasi")%>&videoadi=<%=rstVideoListesi.getString("videoadi")%>"><%=rstVideoListesi.getString("videoadi")%></a></li>
						</figcaption>
